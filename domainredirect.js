...
var searchmobius = 'http://quest.searchmobius.org'
...
if(href.indexOf("missouri.edu") != -1 ){
    var oldDomain = "quest.missouri.edu"
...
if (href.indexOf("&redirected") != -1 ) {
    var redirectMessage = "<p>You've been redirected from quest.mobius.umsystem.edu or quest.missouri.edu. Starting in June of 2012, those addresses will no longer work.</p><p>Please update your bookmarks to <a href='http://quest.searchmobius.org'>http://quest.searchmobius.org</a>.</p>"
